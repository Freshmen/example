define(["FsioBase"], function(FsioBase) {
    ...
    FsioData.prototype.upload = function(
        ...
        var path = "upload/devices/Web/" + object_name;    // Modify to /devices/Web/ to upload files to be seen at the wen folder
        if(params) {
    ...
    FsioData.prototype.download = function(
        ...
        this.requestWithTicket(ticket, "GET", "files/devices/Web/" + object_name,  // Modify to files/devices/Web/ to download file from the web
                               complete, params, headers);
    };
